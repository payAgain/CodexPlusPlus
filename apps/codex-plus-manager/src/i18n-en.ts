...
export const EN_PLAIN: Record<string, string> = {
  ...
  "检测到来自网页的供应商配置导入请求，确认后会写入本机 Codex++。":
    "A provider config import request from the web was detected; confirming writes it to this machine's Codex++.",
  "概览": "Overview",
  ...
  "从 GitHub 仓库安装 Skill 到 Codex。启用后软链到 ~/.agents/skills/，旧的 ~/.codex/skills/ 安装保持兼容。":
    "Install skills from GitHub repositories into Codex. New installs symlink into ~/.agents/skills/, while legacy ~/.codex/skills/ installs stay compatible.",
  "Agents": "Agents",
  "Codex": "Codex",
  "可安装": "Available",
...
export const EN_TEMPLATE: Record<string, string> = {
  ...
  "源目录 {0}；新装技能软链到 {1}，旧版 codex 安装仍在 {2}": "Source directory {0}; new skills symlink into {1}, legacy codex installs stay in {2}",
