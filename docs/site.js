...
const translations = {
  ...
  "处理应用检测、环境冲突、Watcher、更新与诊断日志。": "Handle app detection, environment conflicts, watchers, updates, and diagnostic logs.",
  ...
  "供应商、增强开关和脚本都在独立管理工具中完成，日常使用不用再手工修改配置文件。": "Providers, enhancement controls, and scripts all live in a dedicated manager, so daily use no longer requires editing config files by hand.",
...
const pageMetadata = {
  ...
  en: {
    ...
    description: "Codex++ is an open-source launcher and manager for the OpenAI Codex / ChatGPT desktop app, with provider switching, session management, plugins, scripts, and interface enhancements.",
    ogTitle: "Codex++ - Make Codex work your way",
    ogDescription: "Manage providers, models, sessions, plugins, scripts, and interface enhancements on Windows and macOS.",
  },
  changelog: {
    zh: {
      title: "Codex++ 更新日志",
